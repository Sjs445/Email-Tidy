	...
	max-width: 500px;" class="wrapper">
			...
			padding-bottom: 20px;">
				...
				color: #2D3445;" class="preheader">
								Available on&nbsp;GitHub and&nbsp;CodePen. Highly compatible. Designer friendly. More
								than 50%&nbsp;of&nbsp;total email opens occurred on&nbsp;a&nbsp;mobile device&nbsp;—
			...
			font-family: sans-serif;" class="paragraph">
							...
							a&nbsp;mobile-friendly design is&nbsp;a&nbsp;must for&nbsp;email campaigns.
						</td>
					</tr>
			...
			padding-top: 30px;" class="line">
							<hr color="#565F73" align="center" width="100%" size="1" noshade
			...
			font-family: sans-serif;" class="footer">
							...
							This email template was sent to&nbsp;you becouse we&nbsp;want to&nbsp;make the&nbsp;world
							a&nbsp;better place. <a href="https://github.com/konsav/email-templates/" target="_blank"
								style="text-decoration: underline; color: #828999; font-family: sans-serif; font-size: 13px; font-weight: 400; line-height: 150%;">unsubscribe
							</a>
